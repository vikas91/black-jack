...
class Round(models.Model):
    ...
    player_count = models.IntegerField(default=0)
    dealer_cards = models.CharField(max_length=256, blank=True, null=True)
    remaining_cards = models.CharField(max_length=256, blank=True, null=True)
...
class RoundPlayer(models.Model):
    ...
    player_cards = models.CharField(max_length=256, blank=True, null=True)
    player_count = models.IntegerField(default=0)
